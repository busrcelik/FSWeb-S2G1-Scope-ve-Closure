 ...
 *
 * Aşağdıaki Yüksek dereceden fonskiyonu(higher-order func tion) kullanarak aşağıdakileri yapınız
...
function skorTabelasi(periyotSkoru, takimSkoru, ceyrekSayisi) {
  ...
  for (let i = 1; i <= ceyrekSayisi; i++) {
    ...
    skorTabela.push(
      `${i}. Periyot: Ev Sahibi ${periyot.EvSahibi} - Konuk Takım ${periyot.KonukTakim}`
    );
